...
public class Customer {
    String surname, firstName, patronymic, numberOfCard, bankAccountNumber;
    int id;
    ...
    static void returnCustomer(String bottomBound, String topBound) {
    ...
    static void returnSortedListOfCustomers() {
...
//        Check with debug what a hell is going here
        ...
        for (String besit :
                customers) {
            System.out.println(besit);
        }
    }

    public static void main(String[] args) {
        customerArrayList.add(new Customer("a","b","c","1400000000000001","tryue",12));
        customerArrayList.add(new Customer("v","a","sdf","8000000003000001","vbsdf",12));
        customerArrayList.add(new Customer("a","c","c","1000000000000000","lskdfjsi",12));
        customerArrayList.add(new Customer("a","b","b","1000000000000001","ebyt",12));
    }
